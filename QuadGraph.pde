...
class QuadGraph {
  ...
  void displayQuads(List<PVector> lines) {
    for (int[] quad : quads) {
      ...
      if (isConvex(c12, c23, c34, c41) && nonFlatQuad(c12, c23, c34, c41) && validArea(c12, c23, c34, c41, 125000, 3000)
           && c12.x < 640 && c12.x >0 &&
           c23.x < 640 && c23.x >0 &&
           c34.x < 640 && c34.x >0 &&
           c41.x < 640 && c41.x >0 &&
        ...
        noFill();
        stroke(204, 102, 0);
                println("c12.x = " + c12.x + "       c12.y = " + c12.y);
                println("c23.x = " + c23.x + "       c23.y = " + c23.y);
                println("c34.x = " + c34.x + "       c34.y = " + c34.y);
                println("c41.x = " + c41.x + "       c41.y = " + c41.y);
